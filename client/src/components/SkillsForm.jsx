   ...
   return (
      <div className='space-y-4'>
         ...
         <div className='flex gap-2'>
            <input onKeyDown={handleKeyPress} value={newSkill} onChange={(e) => setNewSkill(e.target.value)} type="text"
               className='flex-1 px-3 py-2 text-sm' placeholder='Enter a skill (e.g. JavaScript, Project Management)' />
            <button onClick={addSkill} disabled={!newSkill.trim()} className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-400 text-white rounded-lg
         ...
         {data.length > 0 ? (
            ...
            <div className='text-center py-3 text-gray-500'>
               <Cog className='size-12 mx-auto mb-2 text-gray-400'/>
         ...
         <div className='bg-teal-50 p-4 rounded-lg'>
            <p className='text-sm text-teal-800'>
               <strong>Tip:</strong>  Add 8-12 relevant skills. Include both technical skills (programming languages, tools) and 
