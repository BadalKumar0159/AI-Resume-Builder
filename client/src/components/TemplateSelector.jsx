...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    return (
        <div className='relative'>
            <button onClick={() => setIsOpen(prev => !prev)} className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br 
            from-blue-50 to-blue-100 hover:ring ring-blue-300 px-3 py-2 rounded-lg transition-all'>
                <Layout size={16}/>
                        ...
                        return (
                            ...
                            'border-blue-400 bg-blue-100' : 'border-gray-300 hover:border-gray-400 hover:bg-gray-100'}`}>
                                ...
                                {selectedTemplate === template.id && (
                                    <div className='absolute top-2 right-2 size-5 bg-blue-400 rounded-full flex items-center justify-center'>
