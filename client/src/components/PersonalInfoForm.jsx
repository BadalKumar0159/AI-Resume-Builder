...
const PersonalInfoForm = ({ data, updatePersonalInfo, removeBackground, setRemoveBackground }) => {

    const handleChange = (field, value) => {
        updatePersonalInfo({ ...data, [field]: value });
    }
    ...
    const fields = [
        ...
        { key: "codeforces", label: "Codeforces Profile", icon: SiCodeforces, type: "url" },
        { key: "codechef", label: "Codechef Profile", icon: SiCodechef, type: "url" },
    ]
    return (
        <div>
            ...
            <div className='flex items-center gap-2'>
                <label>
                    ...
                    <input onChange={(e) => handleChange("image", e.target.files[0])} className='hidden' type="file" accept='image/jpeg, image/png' />
                </label>
                ...
                {typeof data.image === 'object' && (
                    <div className='flex flex-col gap-1 pl-4 text-sm'>
                        ...
                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                            <input type="checkbox" onChange={() => setRemoveBackground(prev => !prev)} checked={removeBackground}
            ...
            {fields.map((field) => {
                ...
                return (
                    <div key={field.key} className='space-y-1 mt-5'>
                        ...
                        className='mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 
